...
gui_device_strain_gauge::gui_device_strain_gauge(jcs::jcs_host* host, gui_interface* gui_if, std::string const& name) :
    gui_device_base(host, gui_if, name)
{
    gui_element_.push_back(new gui_parameter(host_, gui_if_, name_, 
        &jcs::node_parameter::dev_strain_gauge::parameters, &jcs::node_parameter::dev_strain_gauge::parameter_enums));

...
gui_device_thermal_simple::gui_device_thermal_simple(jcs::jcs_host* host, std::string const& name) :
    gui_device_base(host, name)
{
    gui_element_.push_back(new gui_parameter(host_, name_, &jcs::node_parameter::dev_thermal_simple::parameters, &jcs::node_parameter::dev_thermal_simple::parameter_enums));

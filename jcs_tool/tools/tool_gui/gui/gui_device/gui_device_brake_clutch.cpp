...
gui_device_brake_clutch::gui_device_brake_clutch(jcs::jcs_host* host, std::string const& name) :
    gui_device_base(host, name)
{
    gui_element_.push_back(new gui_parameter(host_, name_, &jcs::node_parameter::dev_brake_clutch::parameters, &jcs::node_parameter::dev_brake_clutch::parameter_enums));
    gui_element_.push_back(new gui_bc_tune(host_, name_));
